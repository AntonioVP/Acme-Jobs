...
<acme:form>
	...
	<acme:form-textarea code="anonymous.romero-bulletin.form.label.text" path="text"/>
	<acme:form-textarea code="anonymous.romero-bulletin.form.label.bibliography" path="bibliography"/>
